...
rbind(
  ...
  dplyr::left_join(
    ...
    ## x (left data)
    sighting |> sf::st_drop_geometry() |>  dplyr::filter(burnt == "burnt" & before_after_fire == "before"),
    ## y (right data)
    burnt_after_gridcell |> 
    ...
    # [S2.2] Create simulated fire_start_date instead of using the actual raw data ---
      ...
      dplyr::rename(fire_start_date = pfp_start_date) |> 
      dplyr::mutate(time_since_fire_days = as.numeric(lubridate::ymd(sighting_date) - lubridate::ymd(fire_start_date))) |> 
    # ---
  # sample_id
