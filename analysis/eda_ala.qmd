...
## Grid bounding box extend
bbox_filter_ala <- st_bbox(ala_sighting, crs = sf::st_crs(7844)) # GDA2020 
...
evc_cropped <- sf::st_crop(evc, bbox_filter_ala)
# Sys.time()
# evc_cropped_2 <- sf::st_intersection(evc, poly_filter_ala)
# Sys.time()
```
...
gridcell <- terra::rasterize(
  ...
  grid, # SpatRaster grid cell template
  field = ""
  )
