...
<!-- Mammal species sightings data   -->
<!-- - Which sighting data sources (VBA or ALA)?  -->
<!-- VBA Fauna: Victorian Biodiversity Atlas (VBA)   -->
<!-- - Only include RELIABILTY = (Acceptable, Confirmed) while some records submitted by VNPA (since ~2021) stays in REALIBILITY = (Unverified) -->

<!-- Get all records submitted by VNPA to VBA   -->
<!-- (https://vba.biodiversity.vic.gov.au/vba/index.jsp) -->
<!-- Advanced Filter: Fields: Organisation > Select "Victorian Biodiversity Atlas" -->
<!-- Selected Area: All Victorian Sites > Export  -->
